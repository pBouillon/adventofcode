...
public class Solver : ISolver<Dictionary<string, List<string>>, int>
{
    public string InputPath => "Day12/input.txt";
    ...
    public int PartOne(Dictionary<string, List<string>> input)
    {
    ...
    public int PartTwo(Dictionary<string, List<string>> input)
    {
    ...
    public Dictionary<string, List<string>> ReadInput(string inputPath)
    {
        var paths = File
            .ReadLines(inputPath)
            .Select(line =>
